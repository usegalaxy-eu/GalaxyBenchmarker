...
galaxy_float_metrics = {
    ...
    "memory.stat.total_rss_huge",
    "memory.memsw.failcnt",
    "memory.oom_control.under_oom",
    "memory.kmem.failcnt",
    "memory.stat.total_pgfault",
    "cpu.stat.nr_periods",
    "cpuacct.stat.user",
    ...
    "memory.stat.cache",
    "memory.stat.hierarchical_memsw_limit",
    ...
    "memory.stat.total_active_file",
    "memory.stat.total_mapped_file",
    "cpu.cfs_period_us",
    "memory.stat.pgfault",
    "memory.stat.total_pgpgin",
